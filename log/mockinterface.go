...
//
//	mockgen -package log -source interface.go -destination mockinterface.go
//
...
func (mr *MockLoggerMockRecorder) Access(e any) *gomock.Call {
...
func (m *MockLogger) Accessf(format string, a ...any) string {
	m.ctrl.T.Helper()
	varargs := []any{format}
	for _, a_2 := range a {
...
func (mr *MockLoggerMockRecorder) Accessf(format any, a ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockLoggerMockRecorder) AddOutput(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockLoggerMockRecorder) Auditf(format any, a ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{format}, a...)
...
func (mr *MockLoggerMockRecorder) Debug(e any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Debug", reflect.TypeOf((*MockLogger)(nil).Debug), e)
}

// Debugf mocks base method.
func (m *MockLogger) Debugf(format string, a ...any) string {
	m.ctrl.T.Helper()
	varargs := []any{format}
	for _, a_2 := range a {
		varargs = append(varargs, a_2)
...
func (mr *MockLoggerMockRecorder) Error(e any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Error", reflect.TypeOf((*MockLogger)(nil).Error), e)
}

// Errorf mocks base method.
func (m *MockLogger) Errorf(format string, a ...any) string {
	m.ctrl.T.Helper()
	varargs := []any{format}
	for _, a_2 := range a {
		varargs = append(varargs, a_2)
...
func (mr *MockLoggerMockRecorder) Errorf(format any, a ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{format}, a...)
...
func (mr *MockLoggerMockRecorder) Fatal(e any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Fatal", reflect.TypeOf((*MockLogger)(nil).Fatal), e)
}

// Fatalf mocks base method.
func (m *MockLogger) Fatalf(format string, a ...any) string {
	m.ctrl.T.Helper()
	varargs := []any{format}
	for _, a_2 := range a {
		varargs = append(varargs, a_2)
...
func (mr *MockLoggerMockRecorder) Fatalf(format any, a ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{format}, a...)
...
func (mr *MockLoggerMockRecorder) Info(e any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Info", reflect.TypeOf((*MockLogger)(nil).Info), e)
}

// Infof mocks base method.
func (m *MockLogger) Infof(format string, a ...any) string {
	m.ctrl.T.Helper()
	varargs := []any{format}
	for _, a_2 := range a {
		varargs = append(varargs, a_2)
...
func (mr *MockLoggerMockRecorder) New(id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockLoggerMockRecorder) SetSessionID(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockLoggerMockRecorder) Warn(e any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Warn", reflect.TypeOf((*MockLogger)(nil).Warn), e)
}

// Warnf mocks base method.
func (m *MockLogger) Warnf(format string, a ...any) string {
	m.ctrl.T.Helper()
	varargs := []any{format}
	for _, a_2 := range a {
		varargs = append(varargs, a_2)
