...
func (m *MockAPI) ListWhere(meta record.Record, target any, condition *qb.ConditionExpression, options qb.LimitOffset) errors.TracerError {
	m.ctrl.T.Helper()
...
func (m *MockAPI) Select(target any, query *qb.SelectQuery, options qb.LimitOffset) errors.TracerError {
	m.ctrl.T.Helper()
...
func (mr *MockAPIMockRecorder) UpdateWhere(obj, where any, fields ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{obj, where}, fields...)
